...
Generator.prototype.askFor = function askFor() {
  ...
  var prompts = [
    ...
    },
    {
      type: 'list',
      name: 'feature',
      message: 'Which feature does this value belong to?',
    ...
    },
    {
      type: 'inpuy',
      name: 'value',
      message: 'What is the value to return? (You can leave it blank and fill it later)',
      default: ''
    }
  ];
...
Generator.prototype.files = function files() {
    ...
    this.name = glbUtils.constantify(this.name + '' + this.suffix);

    this.template('value.js', path);
